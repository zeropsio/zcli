...
and your %s.`,
	...
	// project service add
	CmdHelpProjectServiceAdd: "the add Zerops service command.",
	CmdDescProjectServiceAdd: "Creates one Zerops services in an existing project.",
	...
	// service stop
	CmdHelpServiceStop: "the stop Zerops service command.",
...
at https://docs.zerops.io/references/cli for further details.`,
	...
	ServiceStackTypeSelectorPrompt:                 "Please, select a service type",
	ServiceStackTypeSelectorOutOfRangeError:        "We couldn't find a service type with the index you entered. Please, try again or contact our support team.",
	ServiceStackTypeVersionSelectorPrompt:          "Please, select a service type version",
	ServiceStackTypeVersionSelectorOutOfRangeError: "We couldn't find a service type version with the index you entered. Please, try again or contact our support team.",

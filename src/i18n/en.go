...
const (
	...
	ServiceStopHelp   = "the service start command"
	...
	ClientId             = "If you have access to more than one client, you must specify the client ID for which the project is to be created"
	ConfirmDeleteProject = "If set, zCLI will not ask for confirmation"
	ConfirmDeleteService = "confirm to delete the service"
	LogLimit             = "How many of the most recent log messages will be returned. Allowed interval is <1;1000>.\nDefault value = 100."
	LogMinSeverity       = "Returns log messages with requested or higher severity. Set either severity number in the interval\n<0;7> or one of following severity codes:\nEMERGENCY, ALERT, CRITICAL, ERROR, WARNING, NOTICE, INFORMATIONAL, DEBUG."
	...
	ZeropsLoginDesc    = "Your login e-mail. Automatically filled if the ZEROPSLOGIN environment variable exists."
	RegionParamDesc    = "Choose one of Zerops regions. Use the \"zcli region list\" command to list all Zerops regions."
	ZeropsPwdDesc      = "Your password. Automatically filled if the ZEROPSPASSWORD environment variable exists."
	ZeropsTokenDesc    = "Zerops token. Automatically filled if the ZEROPSTOKEN environment variable exists."
	...
	// vpn start
	MtuDesc                            = "Sets a custom MTU for VPN interface. Default value is 1420."

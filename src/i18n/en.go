...
const (
	...
	ProjectStartProcessInit  = "start project command initialized"
	ProjectStartSuccess      = "project started successfully"
	ProjectStopProcessInit   = "stop project command initialized"
	ProjectStopSuccess       = "project stopped successfully"
	ProjectDeleteConfirm     = "Please confirm that you would like to delete the project (y/n): "
	ProjectDeleteProcessInit = "delete project command initialized"
	...
	ServiceStartProcessInit  = "start service command initialized"
	ServiceStartSuccess      = "service started successfully"
	ServiceStopProcessInit   = "stop service command initialized"
	ServiceStopSuccess       = "project stopped successfully"
	ServiceDeleteConfirm     = "Please confirm that you would like to delete the service (y/n): "
	ServiceDeleteProcessInit = "delete service command initialized"

...
func Finnish() tea.Msg {
	return spinnerFinnish{}
}

func FinnishWithLine(msg string) tea.Msg {
	return spinnerFinnish{msg: &msg}
}

type spinnerFinnish struct {
	msg *string
}
...
func (s *Spinner) update(msg tea.Msg) (cmd tea.Cmd) {
	...
	if finnishMsg, isFinnish := msg.(spinnerFinnish); isFinnish {
		if finnishMsg.msg != nil {
			s.line = *finnishMsg.msg
		}
		s.finished = true
	}
